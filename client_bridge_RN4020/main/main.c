...
//
//#define mESP32_MODE  0   // mode=1 : adv esp32 only
#define mRN4020_MODE  1   // mode=0 : adv esp32 only
...
//    printf("cValue3=%s\n", cValue3 );
    //d11 cValue11_1
    dataModel_get_datByAdvname((char *)adv_name11 ,1 , cValue11_1 );
